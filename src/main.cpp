...
CAmount GetAdvisorsFee(int64_t blockValue, int nHeight) {
    if (nHeight == 1313500) {
        return blockValue * 1;
    } else if (nHeight == 1312500) {
        return blockValue * 1;
    } else if (nHeight == 1311500) {
        return blockValue * 1;
    } else if (nHeight == 1310500) {
        return blockValue * 1;
    } else if (nHeight == 1309500) {
        return blockValue * 1;
    } else if (nHeight >= 1106500) {
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 1313500) {
        CAmount nSubsidy = 10000000000 * COIN;
        return nSubsidy;
    } else if (nHeight == 1312500) {
        CAmount nSubsidy = 10000000000 * COIN;
        return nSubsidy;
        ...
        CAmount nSubsidy = 10000000000 * COIN;
        return nSubsidy;
    } else if (nHeight >= 1309501) {
        CAmount nSubsidy = 3675 * COIN;
        return nSubsidy;
    } else if (nHeight >= 1106500) {
