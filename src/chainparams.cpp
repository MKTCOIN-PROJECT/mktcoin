...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("vps-a6a5c9a4.vps.ovh.net", "vps-a6a5c9a4.vps.ovh.net"));
        vSeeds.push_back(CDNSSeedData("vps-ab17477e.vps.ovh.ca", "vps-ab17477e.vps.ovh.ca"));
