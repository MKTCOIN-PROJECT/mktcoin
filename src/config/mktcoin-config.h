/* src/config/mktcoin-config.h.  Generated from mktcoin-config.h.in by configure.  */
/* src/config/mktcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MKTCOIN_CONFIG_H

#define MKTCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/Mktcoin-official/Mktcoin"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MktCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MktCoin Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mktcoin"
